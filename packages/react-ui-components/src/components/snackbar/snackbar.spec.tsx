...
describe('Snackbar', () => {
  it('renders', () => {
    const { asFragment } = render(<Snackbar open timeout={1000} onClose={() => {}} message="This is a new message" action={<div />} />);

    expect(asFragment()).toMatchSnapshot();
  });

  it('can be leading', () => {
    const { container } = render(<Snackbar open message="This is a new message" leading />);
    expect(container.firstChild).toHaveClass('mdc-snackbar--leading');
  });

  it('can have an icon', () => {
    render(<Snackbar icon="favorite" open message="This is a new message" leading />);
  ...
  it('handles events', async () => {
    ...
    render(<Snackbar open timeout={1000} onClose={onClose} message="This is a new message" dismissIcon action={<SnackbarAction label="foo" />} />);
