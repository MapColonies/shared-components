...
export const TrailingAction = createComponent<TrailingActionProps>(function TrailingAction(props, ref) {
  return (
    <Tag tag="buton" className="mdc-chip-trailing-action" aria-hidden={props.isNavigable} ref={ref}>
      <span className="mdc-chip-trailing-action__ripple"></span>
      <span className="mdc-chip-trailing-action__icon material-icons">{props.icon}</span>
    </Tag>
  );
});
