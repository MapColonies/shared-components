...
export default function Readme() {
  return (
    <Docs title="Provider" lead="A component that provides global configuration for RMWC." module="@rmwc/provider" styles={[]} examples={examples}>
      <DocsP>
      ...
      <DocProps src={propsSrc} components={[{ displayName: 'RMWCProvider', component: RMWCProvider }]} />
    </Docs>
  );
}
