...
export default function Readme() {
  return (
    ...
    >
      ...
      <DocsP>
        Wrap any component in a `Tooltip` and provide the content attribute. The only requirement is that is has a single React child, and that the
        child can accept `onMouseEnter`, `onMouseLeave`, `onFocus`, and `onClick` props.
      </DocsP>
      ...
      <DocsExample label="Alignment">
        {function AlignmentExample() {
          return ['left', 'right', 'top', 'bottom', 'topLeft', 'topRight', 'bottomLeft', 'bottomRight'].map((align) => (
            //@ts-ignore
      ...
      <DocsP>The RMWCProvider allows you to specify global defaults for your tooltips.</DocsP>
      ...
      <DocProps src={propsSrc} components={[{ displayName: 'Tooltip', component: Tooltip }]} />
    </Docs>
  );
}
