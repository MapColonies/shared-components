        ...
        {!!def.props.length && (
          <>
            ...
            <>
              ...
              {def.props.map((prop) => (
                <>
                  | `{prop.name}` | `{prop.type.replace(/\|/g, '\\|')}` | {prop.description} |
                  <Br />
                </>
              ))}
            </>
...
function DocsExampleBase({ code }: { code: string; codeOnly?: boolean; iframe?: boolean; label?: string; children?: React.ReactNode }) {
  return (
    <>
      ```jsx
      <Br />
