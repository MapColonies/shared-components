...
export default function Readme() {
  return (
    <Docs
      ...
      module="@rmwc/button"
      styles={['@material/button/dist/mdc.button.css', '@rmwc/@rmwc/icon/icon.css', '@material/ripple/dist/mdc.ripple.css']}
    ...
    >
      ...
      <DocProps src={propsSrc} components={[{ displayName: 'Button', component: Button }]} />
    </Docs>
  );
}
