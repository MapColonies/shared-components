...
describe('TopAppBar', () => {
  ...
  test('can be fixed', () => {
    ...
    expect(container.firstChild?.firstChild).toHaveClass('mdc-top-app-bar--fixed');
  });
  ...
  test('can be shortCollapsed', () => {
    ...
    expect(container.firstChild).toHaveClass('mdc-top-app-bar--short-collapsed');
  });
...
describe('TopAppBarFixedAdjust', () => {
  it('renders', () => {
    ...
    expect(container.getElementsByClassName('mdc-top-app-bar--fixed-adjust')).toHaveLength(1);
  });

  it('can be short', () => {
    const { container } = render(<TopAppBarFixedAdjust short />);
    expect(container.getElementsByClassName('mdc-top-app-bar--short-fixed-adjust')).toHaveLength(1);
  });

  it('can be dense', () => {
    const { container } = render(<TopAppBarFixedAdjust dense />);
    expect(container.getElementsByClassName('mdc-top-app-bar--dense-fixed-adjust')).toHaveLength(1);
  });

  it('can be prominent', () => {
    const { container } = render(<TopAppBarFixedAdjust prominent />);
    expect(container.getElementsByClassName('mdc-top-app-bar--prominent-fixed-adjust')).toHaveLength(1);
  });

  it('can be denseProminent', () => {
    const { container } = render(<TopAppBarFixedAdjust denseProminent />);
    expect(container.getElementsByClassName('mdc-top-app-bar--dense-prominent-fixed-adjust')).toHaveLength(1);
  });
});
