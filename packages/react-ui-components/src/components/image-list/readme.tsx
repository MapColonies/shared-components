...
export default function Readme() {
  return (
    ...
    >
      ...
      <DocsP>
        Image Lists will give you basic layout, but you will have to use inline styling or CSS to achieve things like spacing, aspect ratio, and
        column count. Check out the inline styles below as examples.
      </DocsP>
