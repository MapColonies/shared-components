...
/** The Typography Component */
export const Typography = createComponent<TypographyProps, TypographyHTMLProps>(function Typography(props, ref) {
  ...
  const tag = typographyOptions?.[use] || typographyOptions?.defaultTag || 'span';
