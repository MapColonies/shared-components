...
export default function Readme() {
  return (
    ...
    >
      ...
      <DocsP>You can globally map specify type classes to HTML tags for semantics, or specify a default to be used instead of `span`.</DocsP>
      ...
      <DocProps src={propsSrc} components={[{ displayName: 'Typography', component: Typography }]} />
    </Docs>
  );
}
