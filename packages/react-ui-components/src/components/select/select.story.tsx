...
storiesOf('Select', module)
  ...
  .add('Select without placeholder', () => <Select label={text('label', 'Foods')} options={array('options', ['Cookies', 'Pizza', 'Icecream'])} />)
  ...
  .add('autoFocus', () => <Select label="Autofocus" autoFocus value="one" options={['one', 'two', 'three']} />)
