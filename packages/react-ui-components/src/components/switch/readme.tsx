...
export default function Readme() {
  return (
    <Docs
      ...
      module="@rmwc/switch"
      styles={['@material/switch/dist/mdc.switch.css', '@material/form-field/dist/mdc.form-field.css', '@material/ripple/dist/mdc.ripple.css']}
      docsLink="https://material.io/develop/web/components/input-controls/switches/"
      examples={examples}
    >
      <DocsP>Switches are identical in function to the Checkbox component, they just present a different UI / UX paradigm.</DocsP>
      ...
      <DocsExample label="Controlled">
        {function Example() {
          ...
          return <Switch checked={checked} onChange={(evt) => setChecked(!!evt.currentTarget.checked)} label="Cookies" />;
        }}
      </DocsExample>
      ...
      <DocProps src={propsSrc} components={[{ displayName: 'Switch', component: Switch }]} />
    </Docs>
  );
}
