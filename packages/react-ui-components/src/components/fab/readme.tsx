...
export default function Readme() {
  return (
    <Docs
      ...
      module="@rmwc/fab"
      styles={['@material/fab/dist/mdc.fab.css', '@rmwc/icon/icon.css', '@material/ripple/dist/mdc.ripple.css']}
    ...
    >
      ...
      <DocProps src={propsSrc} components={[{ displayName: 'Fab', component: Fab }]} />
    </Docs>
  );
}
