...
const LibraryIntegrationsDocs = () => <DocsMarkdown fileSrc={LibraryIntegrationsMD} />;
...
const LinearProgressDocs = React.lazy(() => import('@rmwc/linear-progress/readme'));
const CircularProgressDocsDocs = React.lazy(() => import('@rmwc/circular-progress/readme'));
const ListDocs = React.lazy(() => import('@rmwc/list/readme'));
const ListCollapsibleDocs = React.lazy(() => import('@rmwc/list/readme-collapsible'));
