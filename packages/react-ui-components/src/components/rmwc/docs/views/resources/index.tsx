...
const RESOURCES: ResourceT[] = [
  {
    ...
    actions: [{ label: 'Visit Github', url: 'https://github.com/jamesmfriedman/rmwc' }],
  },
  {
    name: 'Code Sandbox',
    ...
    icon: (
      <svg viewBox="0 0 24 24">
        <path fill="inherit" d="M14.6,16.6L19.2,12L14.6,7.4L16,6L22,12L16,18L14.6,16.6M9.4,16.6L4.8,12L9.4,7.4L8,6L2,12L8,18L9.4,16.6Z" />
      </svg>
    ),
    actions: [
      {
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24">
        <path fill="inherit" d="M12,2L1,21H23M12,6L19.53,19H4.47M11,10V14H13V10M11,16V18H13V16" />
      </svg>
    ),
    actions: [
      {
...
function ResourceCard({ resource }: { resource: ResourceT }) {
  return (
    <Card className={styles.card}>
      <CardPrimaryAction tag="a" href={resource.url} target="_blank" style={{ flex: 1 }}>
        <CardMedia
      ...
      <CardActions>
        <CardActionButtons>
          {resource.actions.map((a) => (
            <CardActionButton key={a.label} tag="a" href={a.url} label={a.label} target="_blank" />
          ))}
        </CardActionButtons>
      </CardActions>
    </Card>
