...
export default function Readme() {
  return (
    ...
    >
      ...
      <DocProps src={propsSrc} components={[{ displayName: 'LinearProgress', component: LinearProgress }]} />
    </Docs>
  );
}

export const galleryExample = <LinearProgress style={{ minWidth: '10rem' }} progress={0.6} />;
