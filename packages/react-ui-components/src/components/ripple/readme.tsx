...
export default function Readme() {
  return (
    <Docs
      ...
      examples={examples}
    >
      <DocsP>Ripples will wrap whatever child component you pass it and apply the appropriate classes and styles.</DocsP>
      <DocsExample>
        <Ripple>
          <p>Standard Ripple</p>
        </Ripple>
      ...
      <DocProps src={propsSrc} components={[{ displayName: 'Ripple', component: Ripple }]} />
    </Docs>
  );
}
