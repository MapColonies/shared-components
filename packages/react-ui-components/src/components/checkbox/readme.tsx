...
export default function Readme() {
  return (
    <Docs
      ...
      styles={['@material/checkbox/dist/mdc.checkbox.css', '@material/form-field/dist/mdc.form-field.css', '@material/ripple/dist/mdc.ripple.css']}
    ...
    >
      <DocsExample label="Controlled">
        {function Example() {
          ...
          return <Checkbox label="Cookies" checked={checked} onChange={(evt) => setChecked(!!evt.currentTarget.checked)} />;
        }}
      </DocsExample>
      ...
      <DocProps src={propsSrc} components={[{ displayName: 'Checkbox', component: Checkbox }]} />
    </Docs>
  );
}
