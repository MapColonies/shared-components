...
export default function Readme() {
  return (
    <Docs
      ...
      module="@rmwc/card"
      styles={['@material/card/dist/mdc.card.css', '@material/button/dist/mdc.button.css', '@material/icon-button/dist/mdc.icon-button.css']}
      ...
      <DocsExample>
        <Card outlined style={{ width: '21rem' }}>
          ...
          <CardActions fullBleed>
            <CardActionButton label="All Business Headlines" trailingIcon="arrow_forward" />
          </CardActions>
        </Card>
      </DocsExample>
