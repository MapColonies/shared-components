...
/** The Elevation Component */
export const Elevation = createComponent<ElevationProps>(function Elevation(props, ref) {
  const { z = 0, transition = false, wrap, ...rest } = props;

  const className = useClassNames(props, [`mdc-elevation--z${z}`, { 'mdc-elevation-transition': transition }]);
