...
/** Text Wrapper for the ListItem */
export const ListItemText = createComponent<ListItemTextProps>(function ListItemText(props, ref) {
...
/** Primary Text for the ListItem */
export const ListItemPrimaryText = createComponent<ListItemPrimaryTextProps>(function ListItemPrimaryText(props, ref) {
...
/** Secondary text for the ListItem */
export const ListItemSecondaryText = createComponent<ListItemSecondaryTextProps>(function ListItemSecondaryText(props, ref) {
...
/** A graphic / icon for the ListItem */
export const ListItemGraphic = createComponent<ListItemGraphicProps>(function ListItemGraphic(props, ref) {
...
/** Meta content for the ListItem. This can either by an icon by setting the `icon` prop, or any other kind of content. */
export const ListItemMeta = createComponent<ListItemMetaProps>(function ListItemMeta(props, ref) {
...
/** A container to group ListItems */
export const ListGroup = createComponent<ListGroupProps>(function ListGroup(props, ref) {
...
/** A subheader for the ListGroup */
export const ListGroupSubheader = createComponent<ListGroupSubheaderProps>(function ListGroupSubheader(props, ref) {
...
/** A divider for the List */
export const ListDivider = createComponent<ListDividerProps>(function ListDivider(props, ref) {
...
/** A simple list item template. */
export const SimpleListItem = createComponent<SimpleListItemProps>(({ text, secondaryText, graphic, metaIcon, meta, children, ...rest }, ref) => {
  const primaryTextToRender = text && secondaryText !== undefined ? <ListItemPrimaryText>{text}</ListItemPrimaryText> : text;

  const secondaryTextToRender = secondaryText !== undefined ? <ListItemSecondaryText>{secondaryText}</ListItemSecondaryText> : null;
  ...
  return (
    <ListItem {...rest} ref={ref}>
      ...
      {(!!meta || !!metaIcon) && <ListItemMeta icon={metaIcon}>{meta}</ListItemMeta>}
