...
export default function Readme() {
  return (
    <Docs
      ...
      styles={['@material/icon-button/dist/mdc.icon-button.css', '@rmwc/icon/icon.css', '@material/ripple/dist/mdc.ripple.css']}
      docsLink="https://material.io/develop/web/components/buttons/icon-buttons/"
      examples={examples}
    >
      <DocsSubtitle>Basic Usage</DocsSubtitle>
      <DocsP>`IconButton` inherits from the `Icon` component and can be passed icons in the same way.</DocsP>
      ...
      <DocsP>To use as a toggle, specify an additional toggled on state using 'onIcon'.</DocsP>
      ...
      <DocProps src={propsSrc} components={[{ displayName: 'IconButton', component: IconButton }]} />
    </Docs>
  );
}
