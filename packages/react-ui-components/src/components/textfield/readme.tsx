...
export default function Readme() {
  return (
    ...
    >
      ...
      <DocsP>
        You can make the TextField a textarea. Make sure to include `outlined` for proper styling You can optionally make help text always visible by
        passing an object as props with persistent set to true. Textareas can also have an optional character counter which will work with the
        maxLength property.
      </DocsP>
      <DocsExample>
        <div>
      ...
      <DocsP>A preview of how `material-components-web` handles styling input types for your browser.</DocsP>
      ...
      <DocProps src={propsSrc} components={[{ displayName: 'TextField', component: TextField }]} />
    </Docs>
  );
}
