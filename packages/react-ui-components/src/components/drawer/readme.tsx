...
export default function Readme() {
  return (
    ...
    >
      ...
      <DocsP>These are drawers that are permanently fixed inside of a view.</DocsP>
      ...
      <DocsP>These are drawers that can be toggled to an open or closed state inside of a view, but still takes up viewable space when closed.</DocsP>
            ...
            <>
              <div style={{ overflow: 'hidden', position: 'relative' }}>
                ...
                <DrawerAppContent style={{ minHeight: '15rem', padding: '1rem' }}>
                  DrawerAppContent is an optional component that will resize content when the dismissible drawer is open and closed. It must be placed
      ...
      <DocsP>These are drawers that can be temporarily displayed fixed on the side of the entire viewport.</DocsP>
      ...
      <DocsP>
        `material-components-web` doesn't directly support right hand drawers, but it respects the `dir` attribute on DOM elements. This simple hack
        will allow you to get drawers that appear from the right hand side of your app. As an aside, the `dir` attribute can be used to invert many
...
export const galleryExample = (
  <Drawer style={{ transform: 'scale(0.75', boxShadow: '0 0 4px rgba(0,0,0,0.1)' }}>
    <DrawerHeader>
      <DrawerTitle>DrawerHeader</DrawerTitle>
      <DrawerSubtitle>Subtitle</DrawerSubtitle>
    </DrawerHeader>
