...
import { GeocoderOptions, GeocoderPanel } from './geocoder-panel';
...
const GeocoderComponent: React.FC<IGeocoderWidgetProps> = ({ options, locale, isOpen, setIsOpen }) => {

  return (
    <>
      <CesiumIcon onClick={() => setIsOpen(!isOpen)}>
        <svg className="cesium-svgPath-svg" width="32" height="32" fill="var(--mdc-theme-cesium-color)" viewBox="0 0 32 32">
...
export const GeocoderWidget = WidgetWrapper(GeocoderComponent);
